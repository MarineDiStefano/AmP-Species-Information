...
comment.tTJN = 'We assume near-zero values (5 percent of the maximum value) at the upper temperatures of the positive rate range known from literature (280-306K). These data are used as pseudo-data to increase identifiability of the  temperature parameters';
...
weights.tL_larv =10* weights.tL_larv;
