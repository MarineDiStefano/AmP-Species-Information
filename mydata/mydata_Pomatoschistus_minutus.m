...
data.ap = 365;  units.ap = 'd';    label.ap = 'age at puberty';            bibkey.ap = 'BoucQuig1990';
...
data.Li  = 9;   units.Li  = 'cm';  label.Li  = 'ultimate total length';    bibkey.Li  = 'BoucQuig1990';

data.Wwb = 6.3e-5; units.Wwb = 'g'; label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'BoucQuig1990';
  comment.Wwb = 'form L-W relationship at Lb';
data.Wwp = 0.4;  units.Wwp = 'g';   label.Wwp = 'wet weight at puberty';   bibkey.Wwp = 'BoucQuig1990';
  comment.Wwp = 'form L-W relationship at Lp';
data.Wwi = 7;    units.Wwi = 'g';   label.Wwi = 'ultimate wet weight';     bibkey.Wwi = 'BoucQuig1990';
  comment.Wwi = 'form L-W relationship at Li';
...
data.tL = [... %  d, cm
    ...
    300 5.60 ;
	330 5.61];
data.tL(:,1) = data.tL(:,1) - 120; % convert time of the year to age, birth 1st of May
