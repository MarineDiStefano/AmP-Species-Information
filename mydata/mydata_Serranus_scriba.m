...
bibkey.tL = 'AlosPalm2010'; comment.data.tL='Cabrera Reserve in Mallorca Islands';
...
comment.data.LN = 'field data provided the #eggs/batch in May or June; assuming 4 spawnings per yr, as the spawning season extends from May to August, with a peak of spawning activity between May and June in the western Mediterranean (Alonso-Fernandez et al. 2011)';
