function [prdData, info] = predict_Epinephelus_marginatus(par, data, auxData)
  ...
  TC_R92 = tempcorr(temp.R92, T_ref, T_A);
...
% zero-variate data
  ...
  RT_92 = TC_R92 * reprod_rate_j(92 * del_M, f, pars_R);        % #/d, reproduction rate at TL = 92 cm
