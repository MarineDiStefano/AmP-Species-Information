function [prdData, info] = predict_Mycteroperca_microlepis(par, data, auxData)
  ...
  kT_M = TC * k_M; rT_j = rho_j * kT_M; rT_B = rho_B * kT_M;   
  L_b = l_b * L_m; L_j = l_j * L_m; L_i = l_i * L_m; tT_j = (t_j - t_b)/ kT_M; 
